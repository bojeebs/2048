...
// ! calling the callback function and textcontent before the append. console log after everystep to isolate the issue.
...
// ! So this is a mess effectively its supposed to loop through the board and a series of if statements would check cells to left or right or up/down 
// ! it should store all the not 0's in the newBoard array and the for loops will loop through and all merges get matched up.
// ! while loop goes through board and pushes zeros to new array
// ! set old array to new array and then loop through and id each index or set empty string to 0's so they dont display
// ! What I would of done different is break this function into 3 functions with very specific purposes and then pass in those functions with arguments that match 
// ! both functions. So consistency of method through code blocks seems to help the readability and funcitonailty. 
